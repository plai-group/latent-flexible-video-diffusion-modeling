...
if __name__ == "__main__":
    ...
    if args.visualize_mode:
        ...
        assert args.num_sampled_videos is not None, "You must specified how many videos were generated by video_sample.py it not using visualization mode."
    ...
    if args.add_gt:
        ...
        if args.visualize_mode:
            dataset = get_vis_dataset(model_args.dataset, T=T)
        else:
